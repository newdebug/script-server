...
class MY_Upload extends CI_Upload
{
    ...
    public function do_multi_upload ($field)
    {
        ...
        foreach ($_FILES[$field]["name"] as $i => $v)
        {
            ...
            /**
             * BUG:the function clean_file_name it doesn't work in CI 3.0+
             * Issue in github: https://github.com/stvnthomas/CodeIgniter-Multi-Upload/issues/28
             * Modified by Yuri Young<yuri.young@qq.com>
             *
             */
            // $this->file_name = $this->clean_file_name($this->file_name);
            // Replace tow lines below:
            $CI =& get_instance();
